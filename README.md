...
| monitoring\_function\_zip\_package\_path | Zip package path for monitoring function | `string` | `"https://github.com/BzSpi/fame/releases/download/v1.2.0-beta1/fame.zip"` | no |
