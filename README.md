...
| monitoring\_function\_zip\_package\_path | Zip package path for monitoring function. | `string` | `"https://github.com/BzSpi/fame/releases/download/v2.0.0-beta8/fame.zip"` | no |
...
| update\_center\_maintenance\_configurations\_name\_prefix | Prefix for the maintenance configurations names. | `string` | `"mc-"` | no |
