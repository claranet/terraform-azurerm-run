...
| Name | Source | Version |
|------|--------|---------|
| function | claranet/function-app/azurerm | ~> 8.6.0 |
...
| zip\_package\_path | Zip package path for monitoring function. | `string` | `"https://github.com/claranet/fame/releases/download/v2.0.3/fame.zip"` | no |
