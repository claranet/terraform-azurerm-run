module "function" {
  source = "git::ssh://git@git.fr.clara.net/claranet/projects/cloud/azure/terraform/modules/function-app.git?ref=AZ-486-zip-package"
  #source = "../../../function-app-with-plan"
